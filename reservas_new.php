...
if($_POST)
{
	...
	if($_POST['etapa']==2)
	{
		...
		$campos = array('data_chegada', 'hora_chegada', 'data_partida', 'hora_partida');
							...
							<label>
								<span class="input-group">
									...
									<select class="input-group-field placeholder" name="qtd_chd_5">
										<option disabled selected hidden value="0">Bebês (0 a 4 anos)</option>
										<?php
										for($i=0; $i<=10; $i++)
										{
											?>
							...
							<label>
								<span class="input-group">
									...
									<select class="input-group-field placeholder" name="qtd_chd_10">
										<option disabled selected hidden value="0">Crianças (5 a 9 anos)</option>
										<?php
										for($i=0; $i<=10; $i++)
										{
											?>
			...
			else
			{
				...
				else
				{
					...
					<form data-abide novalidate action="" method="post">
						...
						<div class="row small-up-1 medium-up-3">
							<div class="column">
								<strong>Adultos:</strong> <?=$_POST['qtd_adt']?> <em>(10 anos ou mais)</em>
							</div>
							<div class="column">
								<strong>Bebês:</strong> <?=floor($_POST['qtd_chd_5'])?> <em>(0 a 4 anos)</em>
							</div>
							<div class="column">
								<strong>Crianças:</strong> <?=floor($_POST['qtd_chd_10'])?> <em>(5 a 9 anos)</em>
							</div>
						</div>
						<div class="row medium-6">
							<div class="column">
						...
						<div class="row medium-6">
							<div class="column">
								<strong>VALOR TOTAL:</strong> CLP <?=Utils::formata_preco($preco)?> <em>(<?=floor($_POST['qtd_adt']+$_POST['qtd_chd_5']+$_POST['qtd_chd_10'])?>)</em>
							</div>
							<div class="column">
								<a href="#" onclick="window.history.go(-1); return false;">Alterar dados da reserva</a>
							</div>
						</div>
							...
							<div class="column">
								<label>
									<span class="input-group">
										...
										<select class="input-group-field placeholder" name="recomendacao" required>
											<option disabled selected hidden value="">Onde conheceu a gente?</option>
											<option value="Estevão pelo mundo">Estevão pelo mundo</option>
