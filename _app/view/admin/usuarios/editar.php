...
<div class="container-fluid">
    ...
    <div class="row clearfix"><div class="col-lg-12"><div class="card <?=$this->modo?>"><div class="body"><div class="row"><div class="col-xs-12">
        <div class="card-inner">
            <h4 class="card-inner-header">Dados</h4>
            ...
            <div class="row clearfix">
                <div class="col-md-6 col-lg-6">
                    <?php \Campo::write($this, array('id'=>'nome', 'label'=>'Nome')); ?>
                </div>
                ...
                <div class="col-md-6 col-lg-6">
                    <?php \Campo::write($this, array('id'=>'senha1', 'label'=>'Senha', 'type'=>'password', 'obr'=>($this->modo=='inserir' ? 'required' : ''), 'obs'=> ($this->modo=='inserir' ? '' : 'Deixar vazio para manter a atual') )); ?>
                </div>

                <div class="col-md-6 col-lg-6">
                    <?php \Campo::write($this, array('id'=>'senha2', 'label'=>'Confirme a senha', 'type'=>'password', 'obr'=>($this->modo=='inserir' ? 'required' : ''), 'obs'=> ($this->modo=='inserir' ? '' : 'Deixar vazio para manter a atual') )); ?>
                </div>
            ...
            <div class="botoes">
                ...
                <button type="button" class="btn btn-default m-t-15 waves-effect bt_cancelar" data-destino="<?DIR_ADM_HTM_ROOT?>">CANCELAR</button>
